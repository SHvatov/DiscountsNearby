 ...
 *
 * @note: @RegisterExtension in Kotlin won't work, because even if you mark the property in
 * companion block as @JvmStatic, the generated bytecode will still contain private static field and
 * public getter for it, but @RegisterExtension requires filed to be not private.
 */
